...
-- This script must be listed in the .toc after "TrinityFrames_SectionTicket.lua"
-- Also some variables are globally taken from TrinityAdmin.lua

function TrinityAdmin:CreateMiscSection()
  local transparency = {
  ...
  local color = {
    ...
    linkifier = TrinityAdmin.db.account.style.color.linkifier
  }
