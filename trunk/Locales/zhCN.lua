...
function Return_zhCN()
  return {
    ...
    ["tt_MainButton"] = "单击显示 TrinityAdmin 主界面.",
    ...
    ["ma_IconHint"] = "|cffeda55fClick|r 打开TrinityAdmin. |cffeda55fShift-Click|r 重新装载用户界面. |cffeda55fAlt-Click|r 重置求助信息计数.",
    ["ma_Reload"] = "刷新",
    ["ma_LoadMore"] = "装载更多...",
    ...
    ["info_revision"] = "|cFF00FF00Trinity版本:|r ",
