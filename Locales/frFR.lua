...
function Return_frFR() 
  return {
    ...
    ["tt_ItemSetButton"] = "Cliquez pour ouvrir un popup pour rechercher des itemsets et pour gérer vos favoris.",
    ...
    ["tt_ObjectButton"] = "Cliquez pour ouvrir un popup pour rechercher des objets et pour gérer vos favoris.",
    ...
    ["ma_QuestButton"] = "Recherche de quêtes",
    ["ma_CreatureButton"] = "Recherche de créatures",
    ["ma_ObjectButton"] = "Recherche d'objets",
