...
function Return_frFR()
  return {
    ...
    ["tabmenu_Log"] = "Log",
    ["tt_Default"] = "D\195\169placez votre curseur sur une icône pour Act. l'outil correspondant.",
    ...
    ["tt_QuestButton"] = "Cliquez pour ouvrir un popup pour rechercher des quêtes et pour g\195\169rer vos favoris.",
    ...
    ["ma_ItemButton"] = "Items",
    ["ma_ItemSetButton"] = "Rech. d'Itemset",
