...
function Return_enUS()
  return {
    ...
    ["tt_JailAButton"] = "Sends the character whose name appears in this box to the Alliance Jail",
    ["tt_JailHButton"] = "Sends the character whose name appears in this box to the Horde Jail",
    ["tt_UnJailButton"] = "Unjails the character whose name appears in this box.",
    ...
    ["ma_NPCUnFreeze_RandomButton"] = "Move Random",
    ["ma_NPCUnFreeze_WayButton"] = "Move Waypoint",
